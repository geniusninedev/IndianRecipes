...
public class ScallionChicken extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new ScallionChicken.WebViewClient());
        webView.loadUrl("file:///android_asset/scallion.html");
    }
