...
public class MangoPickle extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new MangoPickle .WebViewClient());
        webView.loadUrl("file:///android_asset/mangoo.html");
    }
