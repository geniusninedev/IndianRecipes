...
public class OrangeChicken extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new OrangeChicken.WebViewClient());
        webView.loadUrl("file:///android_asset/orange.html");
    }
