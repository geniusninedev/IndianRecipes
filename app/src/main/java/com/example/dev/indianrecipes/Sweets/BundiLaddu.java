 ...
 * Created by Dev on 28-11-2016.
 */
public class BundiLaddu extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new BundiLaddu.WebViewClient());
        webView.loadUrl("file:///android_asset/bundiladdu.html");
    }
