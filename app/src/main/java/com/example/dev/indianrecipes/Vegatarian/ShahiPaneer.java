...
public class ShahiPaneer extends AppCompatActivity {
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new ShahiPaneer.WebViewClient());
        webView.loadUrl("file:///android_asset/shahipaneer.html");
    }
