...
public class MasalaOmelette extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new MasalaOmelette .WebViewClient());
        webView.loadUrl("file:///android_asset/masalaomelette.html");
    }
