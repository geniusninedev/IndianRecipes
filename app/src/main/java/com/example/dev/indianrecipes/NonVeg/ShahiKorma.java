...
public class ShahiKorma extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new ShahiKorma.WebViewClient());
        webView.loadUrl("file:///android_asset/shahikurma.html");
    }
