...
public class Thalipeeth extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new Thalipeeth.WebViewClient());
        webView.loadUrl("file:///android_asset/thalipeeth.html");
    }
