...
public class EggOmelette extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new EggOmelette .WebViewClient());
        webView.loadUrl("file:///android_asset/eggsomelette.html");
    }
