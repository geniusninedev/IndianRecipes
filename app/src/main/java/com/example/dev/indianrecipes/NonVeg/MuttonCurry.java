...
public class MuttonCurry extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new MuttonCurry.WebViewClient());
        webView.loadUrl("file:///android_asset/muttoncurry.html");
    }
