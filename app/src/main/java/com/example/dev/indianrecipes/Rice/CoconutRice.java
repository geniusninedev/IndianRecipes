 ...
 */
public class CoconutRice extends AppCompatActivity {
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new CoconutRice.WebViewClient());
        webView.loadUrl("file:///android_asset/coconutrice.html");
    }
