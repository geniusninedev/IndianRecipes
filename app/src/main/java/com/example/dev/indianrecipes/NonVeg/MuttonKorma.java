...
public class MuttonKorma extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new MuttonKorma.WebViewClient());
        webView.loadUrl("file:///android_asset/kormaa.html");
    }
