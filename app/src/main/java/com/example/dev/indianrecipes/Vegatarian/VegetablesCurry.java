...
public class VegetablesCurry extends AppCompatActivity {
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new VegetablesCurry.WebViewClient());
        webView.loadUrl("file:///android_asset/vegcurry.html");
    }
