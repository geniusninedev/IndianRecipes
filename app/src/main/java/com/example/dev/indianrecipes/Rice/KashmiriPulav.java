 ...
 */
public class KashmiriPulav extends AppCompatActivity {
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new KashmiriPulav.WebViewClient());
        webView.loadUrl("file:///android_asset/kashmiripulav.html");
    }
