...
public class PotatoPulav extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new PotatoPulav.WebViewClient());
        webView.loadUrl("file:///android_asset/potatopulav.html");
    }
