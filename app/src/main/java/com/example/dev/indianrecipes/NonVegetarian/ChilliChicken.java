...
public class ChilliChicken extends AppCompatActivity{
    WebView webView;
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new ChilliChicken.WebViewClient());
        webView.loadUrl("file:///android_asset/chillichicken.html");
    }
